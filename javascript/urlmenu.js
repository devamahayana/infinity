			var link = document.getElementsByTagName('link');
		 	...
		 	urlmenu[3].setAttribute('href','../../admin/kelas/index.php'); 	/* admin/kelas */
		 	urlmenu[4].setAttribute('href','../../guru/semuaguru/index.php'); 	/* guru/semua guru */
		 	urlmenu[5].setAttribute('href','../../siswa/semuasiswa/index.php'); 	/* guru/semua siswa */
